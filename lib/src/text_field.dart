...
///  * [MyInputDecorator], which shows the labels and other visual elements that
...
class MyTextField extends StatefulWidget {
  ...
  /// Callback that generates a custom [MyInputDecorator.counter] widget.
  ///
...
class _MyTextFieldState extends State<MyTextField> with AutomaticKeepAliveClientMixin {
  ...
  InteractiveInkFeature _createInkFeature(Offset globalPosition) {
    ...
    final RenderBox referenceBox = MyInputDecorator.containerOf(editableContext) ?? editableContext.findRenderObject();
